...
//		a1.DFS(1);
		...
		System.out.println("Number of smaller connected graph : " + a1.numOfSmallConnectedGraph());
		System.out.println("----------------------------------------------");
		...
		System.out.println("Number of smaller connected graph : " + a2.numOfSmallConnectedGraph());
	}
}
